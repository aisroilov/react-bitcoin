  ...
  return (
    <>
      <div className="main-content">
        ...
        selbst überlassen. Angezeigt werden soll jeweils mindestens der Verkauf-
        und Einkaufspreis.
        <ul>
          <li>
        ...
        5. Erstelle eine weitere View “Bitcoin Umrechner" und füge sie dem Menü
        hinzu.
        <ul>
        ...
        <ul>
          ...
          <li>
            ...
            ab sofort wie viel Bitcoin er hat und was diese aktuell in EUR Wert
            ist.
          </li>
          <li>
        ...
        <p>
          ...
          mitteilst. Ist deine Anwendung noch nicht fertig, so stelle bitte den
          aktuellen Stand vor und gebe einen Ausblick.
        </p>
      </div>
    </>
  );
